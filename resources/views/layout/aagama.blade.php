...
<body class="bg-light">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom fixed-top bg-dark">
        ...
        <ul class="nav nav-pills">
          ...
          <li class="nav-item"><li class="nav-item"><a href="/sesi/logout" class="nav-link text-light" aria-current="page">Logout</li></li>
        </ul>
      </header> 
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <br>
                <li>
                    <a href="/siswa"><i class="fa-solid fa-graduation-cap"> Siswa </i></a>
                </li>
                <li>
                    <a href="/agama"style="background:#304ffe;"><i class="fa-solid fa-person-praying"> Agama</i></a>
                </li>
                <li>
                    <a href="/hobi"><i class="fa-regular fa-futbol"> Hobi</i></a>
                </li>
            </ul>
        </div>        
